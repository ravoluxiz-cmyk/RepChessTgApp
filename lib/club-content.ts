...
export const DEFAULT_CLUB_CONTENT: ClubContent[] = [
  ...
  },
  {
    ...
    subtitle: "Здесь будут конспекты лекций, подборки позиций, ссылки на записи и короткие материалы после клубных встреч.",
    body: "Публикуем то, что помогает играть осмысленнее: идеи из партий, разборы типовых позиций, ответы на вопросы после встреч и материалы для тех, кто хочет расти без академического занудства.",
    is_published: true,
    is_featured: false,
    sort_order: 30,
  },
